...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="aac debug doc dts gtk libnotify matroska mp3 mp4 ogm png spell srt theora vorbis x264 xvid"
...
DEPEND="${RDEPEND}
	...
	doc? ( >=dev-libs/libxslt-1.1.20-r1 )"
...
src_prepare() {
	epatch "${FILESDIR}/install-schemas.diff"
...
pkg_postinst() {
	gconftool-2 --makefile-install-rule /etc/gconf/schemas/ogmrip.schemas
}
