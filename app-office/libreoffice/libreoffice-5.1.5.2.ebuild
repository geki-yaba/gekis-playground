...
inherit multiprocessing autotools bash-completion-r1 boost-utils check-reqs eutils java-pkg-opt-2 kde4-base pax-utils python-single-r1 multilib toolchain-funcs flag-o-matic versionator ${SCM_ECLASS}
unset SCM_ECLASS
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	dev-db/unixODBC
	dev-lang/perl
	dev-libs/boost[boost_libs_date_time,boost_libs_filesystem,boost_libs_iostreams]
	dev-libs/expat
	dev-libs/hyphen
	dev-libs/icu:=
